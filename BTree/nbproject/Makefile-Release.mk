...
${OBJECTDIR}/BytesDataInputStore.o: BytesDataInputStore.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BytesDataInputStore.o BytesDataInputStore.cpp

${OBJECTDIR}/BytesDataOutputStore.o: BytesDataOutputStore.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BytesDataOutputStore.o BytesDataOutputStore.cpp

${OBJECTDIR}/DataInput.o: DataInput.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataInput.o DataInput.cpp

${OBJECTDIR}/DataOutput.o: DataOutput.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataOutput.o DataOutput.cpp

${OBJECTDIR}/ManageFileRead.o: ManageFileRead.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManageFileRead.o ManageFileRead.cpp

${OBJECTDIR}/ManageFileWrite.o: ManageFileWrite.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManageFileWrite.o ManageFileWrite.cpp

${OBJECTDIR}/Printer.o: Printer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Printer.o Printer.cpp
...
${OBJECTDIR}/SocketClient.o: SocketClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SocketClient.o SocketClient.cpp

${OBJECTDIR}/StringStringComparator.o: StringStringComparator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringStringComparator.o StringStringComparator.cpp
